...
const About = () => {
  ...
  return (
    <section id="about" className="w-full py-8 px-6">
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="lg:w-1/4">
            <div className="w-48 h-60 md:w-56 md:h-72 rounded-2xl overflow-hidden shadow-xl cursor-pointer group">
              <img 
                src={aboutImage} 
                alt="Rohith Siliveri" 
          ...
          <div className="lg:w-3/4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div 
                className={`info-card py-4 transition-all duration-500 ${
            ...
            {/* Bio */}
            <p 
              className={`text-muted-foreground text-sm leading-relaxed text-center lg:text-left mb-6 transition-all duration-500 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            ...
            <div className="space-y-2">
              <div 
                className={`flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 bg-secondary rounded-xl transition-all duration-500 ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                }`}
